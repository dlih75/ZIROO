...
for n in range(100000):
    ...
    print nmbr
    sys.stdout.flush()
os.system("xdg-open https://www.instagram.com/x_xziro_m")
try:
    import requests
except ImportError:
...
\x1b[1;94mAUTHOR:ZIRO
telegram@XZIRO12
instagram:x_xziro_m
chanale:kurdkurd1234
python
...
def action():
    global cpb
    global oks
    bch = raw_input('halzbhera  ')
    if bch == '':
        print '[!] awa halmabzher'
        action()
    elif bch == '1':
        os.system('clear')
        print logo
        os.system("figlet Ziro")
        print '\x1b[1;91: 0770, 0750, 0773, 0751,0772'
        try:
            c = raw_input(' Zhmarayak halzbhera  : ')
            k = ''
            idlist = '.txt'
